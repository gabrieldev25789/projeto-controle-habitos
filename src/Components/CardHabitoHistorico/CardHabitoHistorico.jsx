...
export function CardHabito({ h, diasPorHabito }) {
    const hoje = new Date()
    const [ano, setAno] = useState(hoje.getFullYear())
    const [mesIdx, setMesIdx] = useState(hoje.getMonth()) // 0-11

    const chave = `${h.val}-${ano}-${mesIdx}`
    ...
    return (
        <li className="habito-item habito-item--good">
